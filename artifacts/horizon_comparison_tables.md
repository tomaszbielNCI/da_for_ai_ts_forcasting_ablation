...
**Key Insights for H3:**
- Best Weighted RMSE: **CatBoost SHAP-10** (0.000000)
...
|---------|------------|---------------|
| H1 | XGBoost SHAP-10 | **0.000000** |
| H3 | CatBoost SHAP-10 | **0.000000** |
| H10 | XGBoost SHAP-10 | **0.000000** |
| H25 | XGBoost SHAP-10 | **0.000000** |

### Overall Best Performance

**Best Model Overall**: XGBoost SHAP-10
**Best Weighted RMSE**: 0.000000
